      ...
      <div className="container mx-auto px-6">
        <div className="flex h-25 items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            <a href="/quiz" className="hidden sm:inline-flex items-center gap-1.5 rounded-full border border-primary/30 px-4 py-1.5 sm:py-2 text-xs sm:text-sm font-mono text-primary hover:bg-primary hover:text-primary-foreground hover:border-primary transition-colors">
              Free AI Readiness Audit
            </a>
            <a href="/ai-strategy-call">
              <Button size="sm" className="inline-flex bg-primary hover:bg-primary/90 text-primary-foreground rounded-full font-mono px-4 sm:px-5 py-1.5 sm:py-2 text-xs sm:text-sm">
                Get Started
              </Button>
            </a>
